---
title: 9) Block Scope & Shadowing
id: Js-Working-block-scope-shadowing
slug: /javascript/internals/block-scope-shadowing
---
...
- Let's observe the behaviour in case of let and const and understand it's reason.
  ...
  <img src={useBaseUrl("/img/js/scope.jpg")} width="600rem" height="200rem" />
