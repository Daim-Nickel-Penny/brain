---
title: 7) Scope & Lexical
id: Js-Working-scope-lexical
slug: /javascript/internals/scope-lexical
---
...
- Let's try to understand the output in each of the cases above.
  ...
  - In **case 4**: A function can access a global variable, but the global execution context can't access any local variable.
    ...
    <img
      src={useBaseUrl("/img/js/lexical.jpg")}
      width="600rem"
      height="200rem"
    />

    <img
      src={useBaseUrl("/img/js/lexical2.jpg")}
      width="600rem"
      height="200rem"
    />
