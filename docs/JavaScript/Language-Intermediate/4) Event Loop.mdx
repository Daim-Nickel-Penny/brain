---
title: 13) Event Loop
id: Js-Working-event-loop
slug: /javascript/internals/event-loop
---
...
- Browser has JS Engine which has Call Stack which has Global execution context, local execution context etc.
  ...
  <img
    src={useBaseUrl("/img/js/eventloop1.jpg")}
    width="600rem"
    height="200rem"
  />
...
<img
  src={useBaseUrl("/img/js/eventloop2.jpg")}
  width="600rem"
  height="200rem"
/>
...
- Let's undertand the below code image and its explaination:
  ...
  <img
    src={useBaseUrl("/img/js/eventloop3.jpg")}
    width="600rem"
    height="200rem"
  />
...
<img
  src={useBaseUrl("/img/js/eventloop4.jpg")}
  width="600rem"
  height="200rem"
/>
...
<img
  src={useBaseUrl("/img/js/eventloop5.jpg")}
  width="600rem"
  height="200rem"
/>
...
<img
  src={useBaseUrl("/img/js/eventloop6.jpg")}
  width="600rem"
  height="200rem"
/>
...
<img src={useBaseUrl("/img/js/microtask.gif")} width="600rem" height="200rem" />
...
<img
  src={useBaseUrl("/img/js/microtask1.gif")}
  width="600rem"
  height="200rem"
/>
<img
  src={useBaseUrl("/img/js/microtask2.gif")}
  width="600rem"
  height="200rem"
/>
<img
  src={useBaseUrl("/img/js/microtask3.gif")}
  width="600rem"
  height="200rem"
/>
<img
  src={useBaseUrl("/img/js/microtask4.gif")}
  width="600rem"
  height="200rem"
/>
<img
  src={useBaseUrl("/img/js/microtask5.gif")}
  width="600rem"
  height="200rem"
/>
<img
  src={useBaseUrl("/img/js/microtask6.gif")}
  width="600rem"
  height="200rem"
/>
